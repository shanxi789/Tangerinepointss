...
public class UserFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        //判断本地是否有优惠券信息如果有则直接获取本地的
        String coupons = (String) SharedPreferencesUtil.getParam(_context,SharedName.COUPONS,"");
    ...
    private void CouponsAvailableRequest(){
        ...
        NetUtil.Request(NetUtil.RequestMethod.GET, Constans.COUPONS_AVAILABLE, null, Authorization, MainApplication.APP_INSTANCE_ID, new NetUtil.RequestCallBack() {
            @Override
            public void onSuccess(int statusCode, String json) {
                ...
                //将优惠券保存到本地
                SharedPreferencesUtil.setParam(_context, SharedName.COUPONS,coupons);
                List<CouponBean> list  = GsonUtil.getListFromJson(coupons,new TypeToken<List<CouponBean>>(){});
                if(!StringUtil.isEmpty(list)){
                lv_coupon.setAdapter(new CouponAdapter(_context,list,R.layout.fragment_user_item));
                }else{
