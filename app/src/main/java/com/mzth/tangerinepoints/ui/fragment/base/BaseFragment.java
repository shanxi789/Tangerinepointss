...
public abstract class BaseFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(resId != -1){
			...
			if(!StringUtil.isEmpty((String) SharedPreferencesUtil.getParam(_context, SharedName.AccessKey, ""))) {
				Authorization = (String) SharedPreferencesUtil.getParam(_context, SharedName.AccessKey, "");
			}
			initData();
