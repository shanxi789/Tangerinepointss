...
public class MerchantActivity extends BaseBussActivity {
    ...
    private void MerchantDetailRequest(){
        ...
        NetUtil.Request(NetUtil.RequestMethod.GET, Constans.BUSINESSES_DETAIL+BusinBean.getBusinessId(), map, Authorization, MainApplication.APP_INSTANCE_ID, new NetUtil.RequestCallBack() {
            @Override
