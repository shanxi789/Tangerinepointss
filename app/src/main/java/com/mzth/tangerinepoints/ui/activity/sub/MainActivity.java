...
import com.mzth.tangerinepoints.common.MyFirebaseMessagingService;
...
public class MainActivity extends BaseBussActivity implements BaseFragment.FragmentCallBack {
    ...
    public static LinearLayout rl_home,ll_inter_no;
    ...
    public static TextView tv_Off;//断网信息
    @Override
    protected void setCustomLayout(Bundle savedInstanceState) {
        ...
        //mPopupWindow = new PopupWindow(popupView, 400, ViewGroup.LayoutParams.WRAP_CONTENT, true);
    ...
    protected void initView() {
        ...
        //断网时显示的布局
        ll_inter_no = (LinearLayout) findViewById(R.id.ll_inter_no);
        //主页viewpager
    ...
    protected void initData() {
        ...
        startService(intent);
        //推送服务开启
        Intent intent1 = new Intent(_context,MyFirebaseMessagingService.class);
        startService(intent1);
        //Intent intent = getIntent();
        //bean = (UserBean) intent.getSerializableExtra("userbean");
        RrofileRequest();//刷新用户信息  此处只是为了设置积分
        //首次进来将标题下面的积分设置成红色
        tv_integral.setTextColor(getResources().getColor(R.color.orange_red));
    ...
    private void RrofileRequest(){
        NetUtil.Request(NetUtil.RequestMethod.GET, Constans.REFRESH_PROFILE, null, (String)SharedPreferencesUtil.getParam(_context,"accessKey",""), MainApplication.APP_INSTANCE_ID, new NetUtil.RequestCallBack() {
            @Override
            public void onSuccess(int statusCode, String json) {
                ...
                //将用户的信息保存到本地
                SharedPreferencesUtil.setParam(_context,SharedName.USERBEAN,user);
                    ...
                    case "Sign Out"://点击退出登录弹出一个对话框
                        DialogUtil.alertDialog(_context, "Confirmation", "Are you sure you want to exit?",
                                "Confirm", "Cancel", true, new DialogUtil.ReshActivity() {
                                    ...
                                    Authorization =null;
                                    //清空用户信息
                                    SharedPreferencesUtil.setParam(_context,SharedName.USERBEAN,"");
                                    //清空offer信息
                                    SharedPreferencesUtil.setParam(_context,SharedName.OFFER,"");
                                    //清空coupons信息
                                    SharedPreferencesUtil.setParam(_context,SharedName.COUPONS,"");
                                    //清空联系人信息
                                    SharedPreferencesUtil.setParam(_context,SharedName.Contacts,"");
