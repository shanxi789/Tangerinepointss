    ...
    class ViewHolder{
        ...
        private void initData(List<UnregisteredBean> list, int position){
            ...
            if(bean.isInvited()){
                ...
                btn_invite.setTextColor(_context.getResources().getColor(R.color.gray_deep));
                btn_invite.setClickable(false);
            }else {
                //点击邀请好友
...
//            }
            ...
            NetUtil.Request(NetUtil.RequestMethod.POST, Constans.CONTACTS_INVITE_SMS, map, Authorization, MainApplication.APP_INSTANCE_ID, new NetUtil.RequestCallBack() {
                @Override
