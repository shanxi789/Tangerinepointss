...
//---------------------------------客户端app---------------------------------------
    ...
    //获得服务器版本
    public final static String GETVERSION ="https://tangerinepoints.com/app-version-info/customer/android.json";
    //请求重置密码
    public final static String RESETPWDCODE ="request-reset-password";
    //重置密码
    public final static String RESETPWD ="reset-password";
}
