...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private void MessagePushRequest(String token){
        ...
        map.put("token",token);
        NetUtil.Request(NetUtil.RequestMethod.POST, Constans.MESSAGE_PUSH, map, (String) SharedPreferencesUtil.getParam(getApplicationContext(),SharedName.AccessKey, ""), MainApplication.APP_INSTANCE_ID, new NetUtil.RequestCallBack() {
            @Override
