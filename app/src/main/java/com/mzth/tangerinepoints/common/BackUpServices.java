...
public class BackUpServices extends Service {
    ...
    private void UnfinishedRequest(String data){
        ...
        NetUtil.Request(NetUtil.RequestMethod.POST, Constans.SYNC_PURCHASES, map, (String) SharedPreferencesUtil.getParam(getApplicationContext(),SharedName.AccessKey,""), MainApplication.APP_INSTANCE_ID, new NetUtil.RequestCallBack() {
            @Override
